...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            # Procesar en lotes para eficiencia y mejor concurrencia
            self.stdout.write('Procesando registros en lotes...')
            batch_size = 1000
            batch_count = 0
            ...
            while True:
                ...
                with transaction.atomic():
                    ...
                    # Fin del lote - el commit se hace automáticamente al salir del with
                    if batch_records > 0:
                        batch_count += 1
                        self.stdout.write(f'Lote {batch_count} completado: {registros_procesados} registros procesados')

                    # Si no se procesaron registros, terminamos
                    if batch_records == 0:
                        break
